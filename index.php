...
<body class="main-layout">
            ...
            <div class="container-fluid">
                <div class="row d_flex">
                    ...
                    <div class="col-sm-5">
                        ...
                        <a class="read_more" href="regf.php">register </a><a class="read_more" href="loginform.php">login </a>
                        <!-- <li  class ="read_more"  href="regf.php">register</li>
                        <li class ="read_more">login</li> -->
                    </div>
                    <div class="col-sm-4">
    ...
    <div id="top_section" class=" banner_main"> 
         <div class="name">
                           <h1> wellcome back <?php echo $_SESSION['uname'];  ?></h1>
             </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
